...
namespace ShopTARgv24.Data.Migrations
{
    ...
    [Migration("20260113085901_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopTARgv24.Core.Domain.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShopTARgv24.Core.Domain.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShopTARgv24.Core.Domain.FileToApi", b =>
                {
                    b.HasOne("ShopTARgv24.Core.Domain.Spaceship", null)
                        .WithMany("Files")
